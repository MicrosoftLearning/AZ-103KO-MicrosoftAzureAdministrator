...
1. **매개 변수 편집** 블레이드에서 매개 변수 파일인 **az-101-04b_azuredeploy.parameters.json**을 로드합니다. 
...
1. **로그아웃하고 다른 계정으로 로그인하는 옵션**을 사용하여 이전 연습에서 다단계 인증을 위해 만들고 구성한 **aaduser1** 계정으로 로그인합니다.
